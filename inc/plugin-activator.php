...
add_action( 'tgmpa_register', 'yellow_box_theme_required_plugins' );
 ...
 */
function yellow_box_theme_required_plugins() {
	/*
	...
	$plugins = array(
		...
		// Megamenu
		array(
			'name'   => 'Yellowbox Megamenu',
			'slug'   => 'yellowbox-megamenu',
			'source' => 'https://github.com/dan-yellowbox/yellowbox-megamenu/archive/refs/heads/main.zip',
		),
