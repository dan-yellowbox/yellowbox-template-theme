...
?>
	...
	<?php if ( get_field('site_notice', 'options') || $phone_number || $email_address ) : ?>
				...
				<div class="row">
					...
					<?php if( $phone_number || $email_address) { ?>
						<div class="col d-none d-lg-block">
							<ul class="nav justify-content-end me-n2">
								<?php if( $phone_number ) { ?>
									<li class="nav-item">
										<a href="tel:<?php echo $phone_number; ?>" class="nav-link px-2 py-0"><?php echo $phone_number; ?></a>
									</li>
								<?php }?>
								<?php if( $email_address ) { ?>
									<li class="nav-item">
										<a href="mailto:<?php echo $email_address; ?>" class="nav-link px-2 py-0"><?php echo $email_address; ?></a>
									</li>
								<?php } ?>
						</div>
					<?php } ?>
	...
	<header id="masthead" class="site-header layout-one <?php echo $header_style; ?>">
